...
def pyg_pipeline():
    ...
    class GCN(torch.nn.Module):
        def __init__(self, hidden_channels):
            ...
            self.conv1 = GATConv_pyg(
                dataset.num_node_features, hidden_channels, concat=False
            )
            self.conv2 = GATConv_pyg(hidden_channels, hidden_channels, concat=False)
            self.conv3 = GATConv_pyg(hidden_channels, hidden_channels, concat=False)
...
def mlx_pipeline():
    ...
    class GCN(nn.Module):
        def __init__(self, in_dim, hidden_dim, out_dim, dropout=0.5):
            ...
            self.conv3 = GATConv(hidden_dim, hidden_dim, concat=False)
